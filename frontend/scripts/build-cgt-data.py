...
PRODUCTS = [
    ...
    ("BLA125787", "2023-12-08", "CRISPR/Cas9 gene-edited cell therapy", "Casgevy", "exagamglogene autotemcel", "Vertex Pharmaceuticals", "Sickle cell disease with recurrent vaso-occlusive crises and transfusion-dependent beta-thalassemia, in patients 12 years and older."),
    ...
    ("BLA125789", "2024-08-01", "MAGE-A4-directed TCR T-cell therapy", "Tecelra", "afamitresgene autoleucel", "Adaptimmune", "Unresectable or metastatic synovial sarcoma in HLA-A*02-positive adults whose tumour expresses MAGE-A4, after prior chemotherapy."),
    ...
    ("BLA125846", "2025-12-09", "Lentiviral ex-vivo gene therapy (WAS)", "Waskyra", "etuvetidigene autotemcel", "Fondazione Telethon", "Wiskott-Aldrich syndrome."),
