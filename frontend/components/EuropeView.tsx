...
import {
  CalendarClock, CheckCircle2, Hourglass, Building2, Sparkles, Info, Star, FlaskConical,
} from 'lucide-react';
...
const EuropeView: React.FC<Props> = ({ query, onSelect, lastVisitISO, onSearchTrials }) => {
